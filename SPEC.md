...
| | |
|---|---|
| Backend modules | **111** files, **35435** lines (`src/`, incl. `src/routes/` and `src/social/`) |
| Test suites | **62** files, **22693** lines (`test/`) — ratio 0.63 test:src |
| HTTP routes | **528** registrations |
| Database tables | **179** (`schema.sql`, 2496 lines) |
