...
| Test suites | **64** files, **25047** lines (`test/`) — ratio 0.63 test:src |
...
| Design + audit docs | **153** markdown files, **39885** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
