...
| | |
|---|---|
| Backend modules | **155** files, **53161** lines (`src/`, incl. `src/routes/` and `src/social/`) |
| Test suites | **112** files, **43175** lines (`test/`) — ratio 0.81 test:src |
| HTTP routes | **704** registrations |
| Database tables | **240** (`schema.sql`, 3586 lines) |
| Client | **10479** lines (`public/index.html`, single file, zero dependencies) |
...
| Design + audit docs | **208** markdown files, **60873** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
