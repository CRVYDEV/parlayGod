...
| Design + audit docs | **148** markdown files, **36060** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
...
148 markdown files, 36k lines, with CLAUDE.md alone 7265 lines of dense prose. Two codices already
