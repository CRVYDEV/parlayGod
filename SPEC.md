...
| Smart contracts | **18** contracts, **3720** lines Solidity, **296** Foundry tests passing |
...
| Design + audit docs | **197** markdown files, **55478** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
...
197 markdown files, 55k lines, with CLAUDE.md alone 13038 lines of dense prose. Two codices already
