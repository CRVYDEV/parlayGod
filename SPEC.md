...
| Test suites | **68** files, **26081** lines (`test/`) — ratio 0.68 test:src |
...
| Design + audit docs | **155** markdown files, **40352** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
