...
| HTTP routes | **636** registrations |
| Database tables | **206** (`schema.sql`, 2965 lines) |
...
| Design + audit docs | **169** markdown files, **44560** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
