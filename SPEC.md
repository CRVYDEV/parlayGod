...
| | |
|---|---|
| Backend modules | **123** files, **40537** lines (`src/`, incl. `src/routes/` and `src/social/`) |
| Test suites | **73** files, **27667** lines (`test/`) — ratio 0.68 test:src |
| HTTP routes | **597** registrations |
| Database tables | **196** (`schema.sql`, 2796 lines) |
| Client | **7,584** lines (`public/index.html`, single file, zero dependencies) |
