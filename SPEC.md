...
| Design + audit docs | **202** markdown files, **57099** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
...
202 markdown files, 57k lines, with CLAUDE.md alone 13590 lines of dense prose. Two codices already
