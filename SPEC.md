...
| | |
|---|---|
| Backend modules | **158** files, **54268** lines (`src/`, incl. `src/routes/` and `src/social/`) |
| Test suites | **113** files, **45217** lines (`test/`) — ratio 0.84 test:src |
...
| Design + audit docs | **211** markdown files, **62548** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
...
catalog, ladder and founder-signed lever (5908 lines) and the extractor never opens it. `rules.js`
