...
| | |
|---|---|
| Backend modules | **156** files, **53347** lines (`src/`, incl. `src/routes/` and `src/social/`) |
| Test suites | **112** files, **43408** lines (`test/`) — ratio 0.80 test:src |
| HTTP routes | **704** registrations |
| Database tables | **240** (`schema.sql`, 3609 lines) |
| Client | **10500** lines (`public/index.html`, single file, zero dependencies) |
...
| Design + audit docs | **208** markdown files, **61073** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
