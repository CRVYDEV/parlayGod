...
| Test suites | **99** files, **33239** lines (`test/`) — ratio 0.71 test:src |
...
| Design + audit docs | **184** markdown files, **51496** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
