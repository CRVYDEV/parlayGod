...
| | |
|---|---|
| Backend modules | **116** files, **38547** lines (`src/`, incl. `src/routes/` and `src/social/`) |
| Test suites | **66** files, **25755** lines (`test/`) — ratio 0.67 test:src |
| HTTP routes | **555** registrations |
| Database tables | **186** (`schema.sql`, 2608 lines) |
...
| Design + audit docs | **159** markdown files, **41000** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
