...
| Design + audit docs | **203** markdown files, **57349** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
...
203 markdown files, 57k lines, with CLAUDE.md alone 13590 lines of dense prose. Two codices already
