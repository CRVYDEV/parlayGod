...
| | |
|---|---|
| Backend modules | **130** files, **41478** lines (`src/`, incl. `src/routes/` and `src/social/`) |
| Test suites | **81** files, **28402** lines (`test/`) — ratio 0.68 test:src |
| HTTP routes | **615** registrations |
