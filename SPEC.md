...
| | |
|---|---|
| Backend modules | **144** files, **47088** lines (`src/`, incl. `src/routes/` and `src/social/`) |
| Test suites | **102** files, **33865** lines (`test/`) — ratio 0.72 test:src |
| HTTP routes | **665** registrations |
| Database tables | **225** (`schema.sql`, 3288 lines) |
| Client | **8405** lines (`public/index.html`, single file, zero dependencies) |
