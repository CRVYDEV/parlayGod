...
| | |
|---|---|
| Backend modules | **110** files, **35464** lines (`src/`, incl. `src/routes/` and `src/social/`) |
...
| Design + audit docs | **149** markdown files, **36359** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
...
149 markdown files, 36k lines, with CLAUDE.md alone 7265 lines of dense prose. Two codices already
