...
| | |
|---|---|
| Backend modules | **105** files, **32774** lines (`src/`, incl. `src/routes/` and `src/social/`) |
| Test suites | **59** files, **20056** lines (`test/`) — ratio 0.61 test:src |
| HTTP routes | **512** registrations |
| Database tables | **173** (`schema.sql`, 2371 lines) |
| Client | **6,298** lines (`public/index.html`, single file, zero dependencies) |
...
catalog, ladder and founder-signed lever (3566 lines) and the extractor never opens it. `rules.js`
