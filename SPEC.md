...
| | |
|---|---|
| Backend modules | **140** files, **45863** lines (`src/`, incl. `src/routes/` and `src/social/`) |
| Test suites | **97** files, **32490** lines (`test/`) — ratio 0.71 test:src |
| HTTP routes | **651** registrations |
| Database tables | **220** (`schema.sql`, 3194 lines) |
