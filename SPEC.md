...
| | |
|---|---|
| Backend modules | **127** files, **41348** lines (`src/`, incl. `src/routes/` and `src/social/`) |
| Test suites | **78** files, **28313** lines (`test/`) — ratio 0.68 test:src |
| HTTP routes | **606** registrations |
| Database tables | **201** (`schema.sql`, 2880 lines) |
