...
| Smart contracts | **15** contracts, **2744** lines Solidity, **198** Foundry tests passing |
...
| Design + audit docs | **182** markdown files, **50127** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
