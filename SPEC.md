...
| | |
|---|---|
| Backend modules | **146** files, **49226** lines (`src/`, incl. `src/routes/` and `src/social/`) |
| Test suites | **104** files, **34796** lines (`test/`) — ratio 0.71 test:src |
| HTTP routes | **682** registrations |
