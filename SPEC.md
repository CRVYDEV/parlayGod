...
| Design + audit docs | **201** markdown files, **56912** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
...
201 markdown files, 57k lines, with CLAUDE.md alone 13590 lines of dense prose. Two codices already
