...
| Smart contracts | **18** contracts, **3776** lines Solidity, **300** Foundry tests passing |
...
| Design + audit docs | **198** markdown files, **55478** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
