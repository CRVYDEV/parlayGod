...
| | |
|---|---|
| Backend modules | **129** files, **41478** lines (`src/`, incl. `src/routes/` and `src/social/`) |
| Test suites | **80** files, **28402** lines (`test/`) — ratio 0.68 test:src |
| HTTP routes | **612** registrations |
| Database tables | **202** (`schema.sql`, 2894 lines) |
