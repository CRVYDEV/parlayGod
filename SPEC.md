...
| Smart contracts | **10** contracts, **1869** lines Solidity, **128** Foundry tests passing |
...
| Design + audit docs | **174** markdown files, **47460** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
