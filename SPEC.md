...
| Database tables | **208** (`schema.sql`, 2965 lines) |
...
| Design + audit docs | **171** markdown files, **45176** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
