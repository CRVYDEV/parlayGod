...
| | |
|---|---|
| Backend modules | **151** files, **51385** lines (`src/`, incl. `src/routes/` and `src/social/`) |
| Test suites | **109** files, **36926** lines (`test/`) — ratio 0.72 test:src |
...
| Smart contracts | **18** contracts, **3776** lines Solidity, **301** Foundry tests passing |
...
| Design + audit docs | **200** markdown files, **56584** lines — indexed in `docs/AUDITS.md`, which states they are point-in-time |
...
198 markdown files, 55k lines, with CLAUDE.md alone 13038 lines of dense prose. Two codices already
