// THE WIRE — the intelligence terminal. Covers: the board (costs, empty state), the
...
assert.equal(r.body.tape, undefined, 'the ticker tape retired with the Portfolio (D11) — the board must not advertise it');
